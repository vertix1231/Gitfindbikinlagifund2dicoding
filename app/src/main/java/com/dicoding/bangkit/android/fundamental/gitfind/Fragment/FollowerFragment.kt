...
class FollowerFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        lisitFollower.clear()
        val datafollower = activity!!.intent.getParcelableExtra<Github>(EXTRA_DATA_FOLLOWER)
        getUserFollowers(datafollower.toString())
...
//    }
    ...
    private fun showRecyclerListFollower() {
        ...
        val followeradapter = FollowerAdapter(lisitFollower)
    ...
    companion object {
        ...
        const val EXTRA_DATA_FOLLOWER = "extra_data_follower"
